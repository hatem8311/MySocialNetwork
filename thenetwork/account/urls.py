...
urlpatterns = [
    ...
    ##post_reset_redirect is a function in both of password_reset , password_reset_done and it needs to editing after using the name space , or an error will be caused
    ...
    password_reset_confirm,{'template_name':'account/reset_password_confirm.html','post_reset_redirect':'account:password_reset_complete'}, name='password_reset_confirm'),
